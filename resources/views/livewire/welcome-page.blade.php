        ...
        <div class="py-4 px-2 lg:mx-4 xl:mx-12 ">
            <div class="flex justify-between">
                ...
                <nav class="flex items-center justify-between flex-wrap gap-6 relative">
                    ...
                    <div id="main-nav" class="w-full flex-grow absolute top-0 right-0 lg:flex items-center lg:w-auto hidden self-end mr-5 lg:mr-0 mt-5 lg:mt-0">
                        <div class="text-sm lg:flex-grow mt-2 animated jackinthebox xl:mx-8 lg:flex">
                            <a href="#home"
        ...
        <div>
            <aside class="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                <div class="relative z-10 max-w-screen-xl px-4  pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div class="max-w-xl sm:mt-1 mt-64 space-y-8 text-center sm:text-right sm:ml-auto">
                        ...
                        <a class="inline-flex text-white items-center px-6 py-3 font-medium bg-rose-500 rounded-lg hover:opacity-75" href="/app/register">
            ...
            <h1 class="text-center text-2xl sm:text-5xl py-10 font-medium">Number one data vending platform in Nigeria..</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 sm:grid-cols-2 text-center mx-6 sm:mx-48 gap-x-5 gap-y-5 my-10">
                <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-yellow-100">
                ...
                <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-red-100">
                ...
                <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-green-100">
                    ...
                    <h3 class="text-xl font-bold p-2">Cable/TV Subscription</h3>
                    <p class="text-xs p-2">Instant recharge of DStv, GOtv, Startimes, e.t.c.</p>

                </div>
                <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-orange-100">
                    ...
                    <h3 class="text-xl font-bold p-2">Electricity Payment</h3>
                    <p class="text-xs p-2">Pay your electricity bill online e.g. EKEDC(PHCN), IKEDC(PHCN), AEDC, PHEDC e.t.c.

                    </p>

                </div>
                <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-purple-100">
                    ...
                    <h3 class="text-xl font-bold p-2">Airtime to Cash</h3>
                    <p class="text-xs p-2">
                        Convert airtime of any network into cash in minutes
                    </p>
...
https://api.whatsapp.com/send?phone=2348135321769&text=Hello%20darmhoo,%20I%20saw%20your%20number%20on%20billshub%20website,%20I%20need%20a%20website.
                    ">
                    <div class="border border-2 shadow-lg rounded-lg py-20 flex flex-col items-center justify-center bg-blue-100">
                        ...
                        <h3 class="text-xl font-bold p-2">Web Development</h3>
                        <p class="text-xs p-2">Get a stunning website of your own at an affordable price</p>
            ...
            <footer class="text-center">
                ...
                <p class="text-center py-5">Crafted with ❤️ by <span class="font-black">
                        <Link href="https://twitter.com/OmodamolaO">@darmhoo</Link>
                    </span></p>
            </footer>
