<x-filament-widgets::widget class="grid grid-cols-3 gap-2">


    <div class="max-w-md bg-blue-100 rounded-xl shadow-md overflow-hidden p-3">
        <a href="buy-airtime">
            <div class=" justify-between items-center">
                ...
                <div class="p-3 text-blue-900 text-center">
                    Buy Airtime
                </div>
            </div>
        </a>
    ...
    <div class="max-w-md bg-cyan-100 rounded-xl shadow-md overflow-hidden p-3">
        <a href="buy-data">
            <div class=" justify-between items-center ">
                <div class="flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-16 block text-black">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-3 text-cyan-900 text-center">
                    Buy Data
                </div>
            </div>
        </a>
    ...
    <div class="max-w-md bg-black  rounded-xl shadow-md overflow-hidden p-3">
        <a href="electricity">
            <div class=" justify-between items-center">
                <div class="flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-16 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="max-w-md bg-orange-200 rounded-xl shadow-md overflow-hidden p-3">
        <a href="cable-tv">
            <div class=" justify-between items-center">
                <div class="flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-16 text-blue-400 mx-auto">>
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="max-w-md bg-gray-100 rounded-xl shadow-md overflow-hidden p-3 ">
        <a href="buy-exam-voucher">
            <div class=" justify-between items-center">
                <div class="flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-16 text-orange-700">
                        <path stroke-linecap="round" stroke-linejoin="round"
