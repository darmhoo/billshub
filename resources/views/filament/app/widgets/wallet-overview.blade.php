<x-filament-widgets::widget>
    ...
    <div class="grid grid-rows-1 grid-cols-1 sm:grid-cols-2 gap-5 auto-cols-auto overflow-auto ">
        <x-filament::section>
            <div class="flex justify-between items-center py-3">
                <div class="flex flex-col gap-2">
                    <h1 class="text-2xl font-bold">{{'₦' . number_format($user->wallet_balance, 2)}}</h1>
                    <p class="text-gray-500 text-sm"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <x-filament::section>
            {{-- Widget content --}}
            <div class="font-bold my-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
