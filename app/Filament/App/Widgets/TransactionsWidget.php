...
class TransactionsWidget extends BaseWidget
{
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                //
                TextColumn::make('transaction_type')->formatStateUsing(fn(string $state): string => ucfirst($state))->searchable()->label('Type')->copyable()
                    ->copyMessage('Type copied')
                    ->copyMessageDuration(1500),
                TextColumn::make('reference')->searchable(),
                TextColumn::make('phone_number')->searchable()->label('Phone'),
                TextColumn::make('description')->searchable()->label('Description')->searchable()->copyable()->copyMessage('description copied')->copyMessageDuration(1500),
                ...
                TextColumn::make('reference')->searchable()->copyable()->copyMessage('reference copied')->copyMessageDuration(1500),
                TextColumn::make('phone_number')->searchable()->label('Phone')->copyable()->copyMessage('phone number copied')->copyMessageDuration(1500),
